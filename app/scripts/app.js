...
(function(document) {
  ...
  function addSearchHeader(query) {
    home.innerHTML += '<h2 class="page-title"><li>query: ' + query + '</li></h2>';
  }
  ...
  window.addEventListener('WebComponentsReady', function() {
     ...
     */
    //The next line request should be reject()
    //getJSON('../dataa/earth-like-results.json')
    //The next line request should be resolve()
